...
export default function FoodDetailsScreen(props) {
  ...
  return (
    <View className="flex-1 bg-white">
      <Image style={{borderBottomLeftRadius: 50, borderBottomRightRadius: 50, height: 345,}} source={require('../assets/images/background.png')}
        blurRadius={40} className="w-full absolute" />
